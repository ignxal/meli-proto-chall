...
const Reviews = ({ reviews: initialReviews, product }: ReviewsProps) => {
    ...
    const handleVote = (id: number, vote: "like" | "dislike", action: "add" | "remove") => {
            ...
            <div className="review-counter-star">
                ...
                <div className="review-counter-bar">
                    <span
                        ...
                        style={{width: `${getNumberOfReviewsWithRating(numberOfStars) * 100 / reviewList.length}%`}}>
                    </span>
                </div>
    ...
    const handleNewReviewChange = (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    const handleNewReviewSubmit = () => {
        ...
        if (title !== "" && comments.length >= 30 && comments.length <= 1500 && rating !== 0) {
            setReviewList(prevReviews => [{...newReviewFormData}, ...prevReviews]);
        ...
        <section>
            ...
            <div className="reviews-summary-container">
                <div className="reviews-avg">
                    ...
                    <p className="review-counter-text">Promedio entre { reviewList.length } opiniones</p>
                </div>
