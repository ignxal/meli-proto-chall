...
const Review = (props: ReviewProps) => {
    ...
    const starsElement = [...Array(5)].map((_, index) => (
        <AiFillStar
            key={index}
            className={(index + 1) <= props.review.rating ? "review-star-filled fs-18px" : "review-star-empty fs-18px"}
        />
    ));
            ...
            <div className="review-likes-container">
                <div className="review-likes">
                    {vote.value === "like" ? (
                        ...
                        <HiOutlineThumbUp className="review-thumb-icon" onClick={() => handleUserVote("like")} />
                    )}
                ...
                <div className="review-likes">
                    {vote.value === "dislike" ? (
                        ...
                        <HiOutlineThumbDown className="review-thumb-icon" onClick={() => handleUserVote("dislike")} />
                    )}
